...
public class SetupRequestJob extends Activity {
    private static final String TAG = SetupRequestJob.class.getName();
    ...
    //public ArrayAdapter<String> dayEndAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_request_setup);
        ...
        Log.e(TAG, "requestJobStart = "+ AssignmentFragment.requestJobStart.substring(0,4)+" "+AssignmentFragment.requestJobStart.substring(4,6)+" "+AssignmentFragment.requestJobStart.substring(6,8));
        ...
        spinnerDayEnd = (Spinner) findViewById(R.id.spinnerDayEnd);
        ...
        yearAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, yearlist);
        spinnerYear.setAdapter(yearAdapter);

        for(int i=0; i<yearlist.length;i++) {
            if (AssignmentFragment.requestJobStart.substring(0,4).equals(yearlist[i])) {
                spinnerYear.setSelection(i);
            }
        }

        monthAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, monthlist);
        spinnerMonth.setAdapter(monthAdapter);

        /*for(int i=0; i<monthlist.length;i++) {
            if (Integer.valueOf(AssignmentFragment.requestJobStart.substring(4,6)) == Integer.valueOf(monthlist[i].toString())) {
                spinnerMonth.setSelection(i);
            }
        }*/
        spinnerMonth.setSelection(Integer.valueOf(AssignmentFragment.requestJobStart.substring(4,6))-1);

        //set day selection
        bigMonthDayAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, bigMonth);
        smallMonthDayAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, smallMonth);
        febMonthNormalAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, FebMonthNormal);
        febMonthLeapAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, FebMonthLeap);

        int year = Integer.valueOf(AssignmentFragment.requestJobStart.substring(0,4));
        switch (AssignmentFragment.requestJobStart.substring(4,6)) {
            case "01":
            case "03":
            case "05":
            case "07":
            ...
            case "12":
                ...
                for (int j=0;j<bigMonth.length; j++) {
                    if (Integer.valueOf(AssignmentFragment.requestJobStart.substring(6,8)).equals(Integer.valueOf(bigMonth[j]))) {
            ...
            case "02":
                if ((year%400 == 0 && year%100 != 0) || year%4 == 0) {
                    ...
                    for (int j=0;j<FebMonthLeap.length; j++) {
                        if (Integer.valueOf(AssignmentFragment.requestJobStart.substring(6,8)).equals(Integer.valueOf(FebMonthLeap[j]))) {
                            spinnerDay.setSelection(j);
                        }
                    }
                } else {
                    ...
                    for (int j=0;j<FebMonthLeap.length; j++) {
                        if (Integer.valueOf(AssignmentFragment.requestJobStart.substring(6,8)).equals(Integer.valueOf(FebMonthNormal[j]))) {
                            spinnerDay.setSelection(j);
                        }
                    }
                }
            ...
            case "11":
                ...
                for (int j=0;j<FebMonthLeap.length; j++) {
                    if (Integer.valueOf(AssignmentFragment.requestJobStart.substring(6,8)).equals(Integer.valueOf(smallMonth[j]))) {
                        spinnerDay.setSelection(j);
                    }
                }
                break;
        ...
        yearEndAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, yearlist);
        spinnerYearEnd.setAdapter(yearEndAdapter);

        for(int i=0; i<yearlist.length;i++) {
            if (AssignmentFragment.requestJobEnd.substring(0,4).equals(yearlist[i])) {
                spinnerYearEnd.setSelection(i);
            }
        }

        monthEndAdapter = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, monthlist);
        spinnerMonthEnd.setAdapter(monthEndAdapter);

        /*for(int i=0; i<monthlist.length;i++) {
            if (Integer.valueOf(AssignmentFragment.requestJobEnd.substring(4,6)) == Integer.valueOf(monthlist[i].toString())) {
                spinnerMonthEnd.setSelection(i);
            }
        }*/

        spinnerMonthEnd.setSelection(Integer.valueOf(AssignmentFragment.requestJobEnd.substring(4,6))-1);

        //set day selection
        bigMonthDayAdapterEnd = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, bigMonth);
        smallMonthDayAdapterEnd = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, smallMonth);
        febMonthNormalAdapterEnd = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, FebMonthNormal);
        febMonthLeapAdapterEnd = new ArrayAdapter<>(SetupRequestJob.this, R.layout.myspinner, FebMonthLeap);

        int yearEnd = Integer.valueOf(AssignmentFragment.requestJobEnd.substring(0,4));
        switch (AssignmentFragment.requestJobEnd.substring(4,6)) {
            case "01":
            case "03":
            case "05":
            case "07":
            ...
            case "12":
                ...
                for (int j=0;j<bigMonth.length; j++) {
                    if (Integer.valueOf(AssignmentFragment.requestJobEnd.substring(6,8)).equals(Integer.valueOf(bigMonth[j]))) {
            ...
            case "02":
                if ((yearEnd%400 == 0 && yearEnd%100 != 0) || yearEnd%4 == 0) {
                    ...
                    for (int j=0;j<FebMonthLeap.length; j++) {
                        if (Integer.valueOf(AssignmentFragment.requestJobEnd.substring(6,8)).equals(Integer.valueOf(FebMonthLeap[j]))) {
                            spinnerDayEnd.setSelection(j);
                        }
                    }
                } else {
                    ...
                    for (int j=0;j<FebMonthNormal.length; j++) {
                        if (Integer.valueOf(AssignmentFragment.requestJobEnd.substring(6,8)).equals(Integer.valueOf(FebMonthNormal[j]))) {
                            spinnerDayEnd.setSelection(j);
                        }
                    }
                }
            ...
            case "11":
                ...
                for (int j=0;j<smallMonth.length; j++) {
                    if (Integer.valueOf(AssignmentFragment.requestJobEnd.substring(6,8)).equals(Integer.valueOf(smallMonth[j]))) {
                        spinnerDayEnd.setSelection(j);
                    }
                }
                break;
    ...
    public void onBackPressed() {
        ...
        /*AssignmentFragment.requestJobStart = spinnerYear.getSelectedItem().toString()+
        ...
        AssignmentFragment.requestJobStart = spinnerYear.getSelectedItem().toString()+
                ...
                f.format(Long.valueOf(spinnerDay.getSelectedItemPosition()+1));

        AssignmentFragment.requestJobEnd = spinnerYearEnd.getSelectedItem().toString()+
                f.format(Long.valueOf(spinnerMonthEnd.getSelectedItemPosition()+1))+
                f.format(Long.valueOf(spinnerDayEnd.getSelectedItemPosition()+1));
